---
layout: post
title: "Guia ràpida sobre com parametritzar Columnes a dplyr"
tags:
  - r
  - cheatsheet
...
Les funcions de `dplyr` estàn pensades per treballar amb noms de columna literals (`group_by(botiga)`, `mutate(total = preu * unitats)`...). Aquesta sintaxi és molt còmoda, però es torna un problema quan el nom de la columna arriba com a paràmetre d'una funció.
