...
Primer de tot, cal recordar que un resultat *no significatiu* no implica necessariament que no existeixi un efecte real o important des d’un punt de vista pràctic. La *significació estadística* és només una eina que indica que, sota el nivell de confiança definit (per exemple, 95%), no podem descartar que les diferències observades hagin ocorregut per casualitat.  

Per tant, aquesta manca de significància pot deure’s a diversos factors:

- **Tamany d’mostra insuficient:** Un tamany petit redueix la potència de l’anàlisi, dificultant detectar efectes reals.
- **Variabilitat elevada:** Dades amb alta dispersió poden amagar efectes reals.
- **Efectes moderats:** Efectes petits o moderats poden no ser detectats en estudis amb menys recursos.
- **Context:** La hipòtesi nulla podria ser veritablement certa, o simplement l’evidència no és suficient per a confirmar-ho.
...
- **Optimisme amb precaució:** Si observes una tendència positiva (per exemple, un tractament que sembla beneficiar els pacients) però amb *p*-valor > 0,05, no has de descartar automàticament aquesta observació. Pot ser un indicatiu d’un efecte real que simplement no s’ha pogut detectar amb la mostra o el disseny de l’estudi.
...
Algunes estratègies recomanades són:

- **Revisar la potència de l’estudi:** ¿El tamany de mostra era adequat? Si no, considera investigar amb una mostra més gran o combinacions de dades mitjançant metanàlisis.
- **Analitzar els intervals de confiança:** Aquests indiquen la gamma probable de l’efecte. Un interval ampli que inclou efectes positius i negatius indica incertesa i que estudis nous poden ajudar a aclarir la conclusió.
...
- **Combinar l’evidència estadística amb el context clínic/pràctic.**
...
Interpretar resultats estadístics que no arriben a la significació requereix una mirada holística, que consideri la mida de l’efecte, els intervals de confiança, la potència de l’estudi i el context clínic. La clau és evitar decisions precipitades i fomentar la recerca addicional, sempre amb un enfocament transparent i crític. Només així, la ciència seguirà avançant cap a conclusions robustes i útils per a la societat.
