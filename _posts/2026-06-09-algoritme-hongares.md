...
L'algoritme transforma la matriu de costos original en una matriu de "costos d'oportunitat" mitjançant operacions aritmètiques sencelles a les files i columnes, buscant zeros que indiquin una assignació òptima. Els passos bàsics són:

Resta de files: Trobar el valor mínim de cada fila i restar-lo a tots els elements d'aquella fila.
...
Economia de plataformes (Matching): Algoritmes de repartiment de menjar a domicili o aplicacions de transport viatger per assignar conductors els clients més propers eficientment.
...
# Mostrem els resultats
print("Tasques assignades els treballadors 1, 2 i 3 respectivament:")
